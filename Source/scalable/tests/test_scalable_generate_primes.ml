...
let double_primes_tests () =
    let cases =
        [((20, P.is_prime), [(from_int 2, from_int 5);
...
let twin_primes_tests () =
    let cases =
        [((20, P.is_prime), [(from_int 2, from_int 3);
